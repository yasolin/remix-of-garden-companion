export default {
  translation: {
    ...
    add: {
      ...
      lastWateredQ: "En son ne zaman suladınız?",
      lastWateredHint: "Sulama planı bu tarihe göre oluşturulacak.",
      neverWatered: "Yeni aldım, henüz sulamadım",
      invalidName: "Lütfen geçerli bir bitki adı girin",
    },
    stages: {
      planted: "Ekildi",
      sprouting: "Filizleniyor",
      growing: "Büyüyor",
      budding: "Tomurcuklanıyor",
      flowering: "Çiçek Açıyor",
      pollinating: "Tozlaşıyor",
      producing: "Ürün Oluşturuyor",
      ripening: "Olgunlaşıyor",
      harvestReady: "Hasada Hazır",
      propagatable: "Çoğaltılabilir",
      dormant: "Dinlenme Döneminde",
      // Legacy keys kept as aliases for older components/data
      planting: "Ekildi",
      germination: "Filizleniyor",
      fruiting: "Ürün Oluşturuyor",
    ...
    locations: {
      ...
      pickExisting: "Kayıtlı konumlardan seç",
      newLocation: "Yeni konum",
      namePlaceholder: "ör. Balkon, Mutfak penceresi",
      categoryLabel: "Tür",
      categories: {
        indoor: "İç mekân",
        balcony: "Balkon",
      ...
      analyzeReminder: "Bu konumu AI ile analiz edip ışık ve nem ipuçlarını al!",
      analyzeCta: "Konum analizini başlat",
      plantsHere: "Buradaki bitkiler",
      save: "Kaydet",
      confirmDelete: "Konumu silmek istiyor musun? Bu konuma bağlı bitkilerin konumu boşalır.",
    },
    ai: {
      title: "AI Asistan",
    ...
    mainView: {
      ...
      tasksCount: "{{count}} görev var",
      needsWaterShort: "{{count}} bitki sulanmalı",
      harvestReadyShort: "{{count}} bitki hasada hazır",
      viewTasks: "Görevleri Gör",
      quickActions: "Hızlı İşlemler",
      addPlant: "Bitki Ekle",
      identifyPlant: "Bitkini Tanı",
      joinCommunity: "Topluluğa Katıl",
      todaysTip: "Bugüne Özel Öneri",
      tipHot: "Hava sıcak! Sulamayı akşama bırakmak bitkilerin için daha iyi olacak.",
      tipCold: "Hava soğuk! Hassas bitkilerini iç mekana al.",
      tipRain: "Yağmurlu bir gün, balkondaki bitkilerini sulamayı atla.",
      tipGood: "Hava bitkilerin için ideal. İyi bir bakım günü!",
      viewAll: "Tümünü Gör",
      wateringTime: "Sulama zamanı",
      harvestReady: "Hasada hazır",
      water: "Sulama Yap",
      harvest: "Hasat Et",
      discover: "Keşfet",
      discoverPlant: "Bu hafta ne ekilir?",
      discoverPlantDesc: "Ekim takvimine göz at",
      discoverAi: "Bitkini analiz et",
      discoverAiDesc: "AI ile hızlı teşhis yap",
      discoverCommunity: "Topluluktan ilham al",
      discoverCommunityDesc: "Deneyimlerini paylaş ve tavsiye al",
      careCalendar: "Bitki Bakım Takvimi",
      myPlants: "Bitkilerim",
      view: "Görüntüle",
      today: "Bugün",
      thisWeek: "Bu Hafta",
      wateringSubtitle: "{{count}} bitki sulanmalı",
      harvestSubtitle: "{{count}} bitki hasada hazır",
      plantingSubtitle: "{{count}} bitki ekim zamanı",
      diagnosisTitle: "Bitki Analiz ve Teşhisi",
      diagnosisSubtitle: "Kontrol önerilir",
      noPlants: "Henüz bitki eklemedin",
    },
  },
};
