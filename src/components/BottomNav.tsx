...
const tabs = [
  ...
  { path: "/my-plants", label: "Bitkilerim", icon: Leaf },
  { path: "/ai-assistant", label: "AI Asistan", icon: Bot, isCenter: true },
          ...
          if (tab.isCenter) {
            return (
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-primary mt-1 block text-center">
                  {tab.label}
                </span>
              </button>
            );
